-- Add Insertion Order ID - DSP to placement tables.
...
DECLARE
  ...
  v_cols text[] := ARRAY[
    ...
    'dark_days', 'per_day_impressions', 'dark_ranges', 'assigned_ranges', 'insertion_order_id_dsp'
  ];
BEGIN
...
-- Backfill: add insertion_order_id_dsp to existing order tables.
DO $$
DECLARE
  r RECORD;
BEGIN
