-- Add trafficker to ensure_placement_columns so placement tables get the column.
...
DECLARE
  v_col_name text;
  v_cols text[] := ARRAY[
    'advertiser', 'order_number', 'order_campaign_id', 'order_campaign', 'agency', 'category', 'trafficker',
