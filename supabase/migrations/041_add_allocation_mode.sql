-- Add allocation_mode to persist "spread" vs "custom" for placement impressions allocator
...
DECLARE
  ...
  v_cols text[] := ARRAY[
    ...
    'dark_days', 'per_day_impressions', 'allocation_mode'
  ];
BEGIN
...
-- Backfill allocation_mode for existing tables
DO $$
DECLARE
  r RECORD;
BEGIN
